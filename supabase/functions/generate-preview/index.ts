...
const IMAGEN_API_KEY = "AIzaSyBMhhDH6Y66mB_pbu6rNvz7S2BoFa6S8GU";
...
async function generateAdImages(
  ...
  const prompt = `Professional Facebook ad creative for: ${businessName}. ${description}. Modern, eye-catching, clean design with brand colors. No text overlay. High quality product/service photography style.`;

  console.log("[generate-preview] Imagen prompt:", prompt);
  ...
  if (!response.ok) {
    ...
    console.error("[generate-preview] Imagen API error:", errorText);
