  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "var(--glow-secondary)" },
      ...
      backgroundImage: {
        ...
        "grid-pattern": "url(\"data:image/svg+xml,%3csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3e%3cg fill='none' fill-rule='evenodd'%3e%3cg fill='%23ffffff' fill-opacity='0.03'%3e%3ccircle cx='30' cy='30' r='1'/%3e%3c/g%3e%3c/g%3e%3c/svg%3e\")",
      },
      boxShadow: {
        ...
        glass: "0 4px 24px rgba(0,0,0,0.4), 0 1px 2px rgba(182,196,255,0.05)",
